                    ...
                    <div class="row" style="border-bottom: 1px solid #E0E0E0; padding-bottom: 5px; margin-bottom: 5px;">
                      ...
                      <div id="showArea" class="" role="tabpanel" data-example-id="togglable-tabs" style="margin-bottom: 100px;">
                        <ul id="myTab" class="nav nav-tabs bar_tabs right" role="tablist">
                          ...
                          <li id="x_press" role="presentation" class=""><a href="#tab_content3" role="tab" id="x-tab" data-toggle="tab" aria-expanded="false">المواعيد <span class="badge bg-green">{{count($appointmentsx)}}</span></a>
                          </li>
                          @endif
                        ...
                        <div id="myTabContent" class="tab-content">
                          ...
                          <div class="col-md-7 col-sm-12 col-xs-12">
                            ...
                            <div class="x_content">
                              ...
                              <table id="datatable" class="table table-striped cc">
                                <thead>
                                  <tr>
                          ...
                          <div class="col-md-12 pull-right">
                               <a href="/dashboard/manager/myCalendar" class="btn btn-success"> تقويمي </a>
                            </div>
