                    ...
                    <p>يوجد {{$events_number}} احداث لليوم</p>
                      ...
                      <div id="showArea" class="" role="tabpanel" data-example-id="togglable-tabs">
                        <ul id="myTab" class="nav nav-tabs bar_tabs right" role="tablist">
                          ...
                          <li role="presentation" class=""><a href="#tab_content3" role="tab" id="x-tab" data-toggle="tab" aria-expanded="false">مواعيد بانتظار التاكيد <span class="badge bg-green">{{count($appointmentsx)}}</span></a>
                          </li>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input accept="image/*,.doc,.docx,.pdf" title="ملف/صورة الهوية" type="file" accept="image/*" id="id_image" name="id_image" data-validate-length-range="100" data-validate-words="1" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
