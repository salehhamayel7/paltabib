             <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a href="/dashboard/manager/money"><i class="fa fa-usd"></i>المالية</span></a>
                  </li>
                  <li><a href="/dashboard/manager/patientsRecords"><i class="fa fa-book"></i>سجل المرضى والمراجعات</span></a>
                  </li>
                  <li><a href="/dashboard/manager/search"><i class="fa fa-search"></i>البحث</span></a>
                  </li>
                  @if($user->role == "Manager,Doctor")
                  <li><a href="/dashboard/manager/myCalendar"><i class="fa fa-calendar"></i>التقويم (مواعيدي)</span></a>
                  </li>
                  @endif
                   <li><a href="/dashboard/manager/calendar"><i class="fa fa-calendar"></i>تقويم الاطباء</span></a>
                  </li>
                </ul>
              </div>
